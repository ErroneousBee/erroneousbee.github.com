...
function pieMouseDown(e) {
	...
	if (document.addEventListener) {
		document.addEventListener("mouseup",pm_select_action,true);
		document.addEventListener("mousemove",pm_mouse_move,false);
	}
	else if (document.attachEvent) {
		document.attachEvent("onmouseup",pm_select_action);
...
function pm_select_action (e) {
	...
	if (document.removeEventListener) {
		document.removeEventListener("mouseup",pm_select_action,true);
		document.removeEventListener("mousemove",pm_mouse_move,false);
	}
	else if (document.detachEvent) {
		document.detachEvent("onmouseup",pm_select_action);
